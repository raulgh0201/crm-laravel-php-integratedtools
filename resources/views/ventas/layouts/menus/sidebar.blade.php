        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">            
              <li class="nav-item">
                <a href="{{ route('sales.prospects') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p class="pnav">Prospectos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('sales.clients') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('sales.vender.index') }}" class="nav-link">
                  <i class="iconav fas fa-shopping-cart"></i>
                  <p class="pnav">Vender</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('sales.ventas.index') }}" class="nav-link">
                  <i class="iconav fas fa-shopping-cart"></i>
