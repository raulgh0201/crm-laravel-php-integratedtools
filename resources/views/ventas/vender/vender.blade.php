...
@section('content'))
    <div class="row">
        <div class="col-12">
            ...
            @include("ventas.productos.notificacion")
            <div class="row">
                <div class="col-12 col-md-6">
                    <form action="{{route("sales.terminarOCancelarVenta")}}" method="post">
                        @csrf
                ...
                <div class="col-12 col-md-6">
                    <form action="{{route("sales.agregarProductoVenta")}}" method="post">
                        @csrf
                        <div class="form-group">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach(session("productos") as $producto)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route("sales.quitarProductoDeVenta")}}" method="post">
                                        @method("delete")
                                        @csrf
