...
<div class="col-md-8">
    ...
    <div class="btn-group">
        <a href="{{ route('admin.task.edit', ['id' => $task_view->id ]) }}" class="btn btn-primary"> Editar </a>
        <a class="btn btn-default" href="{{ route('admin.task.show') }}">Volver Atrás</a>
    </div>
    ...
    <div class="row">
        ...
        @if( count($files_set) > 0 ) 
            <div class="col-md-6">
                ...
                <div class="panel panel-jc">
                    <div class="panel-heading"> Ficheros subidos</div>
                    <div class="panel-body">
                        <ul id="images_col">
    ...
    <div class="panel panel-jc">
        ...
        <div class="panel-body">
            <span class="label label-jc">
                <a href="{{ route('admin.task.list', [ 'projectid' => $task_view->project->id ]) }}">{{ $task_view->project->project_name }}</a>
            </span>
        </div>
    </div>
