...
<section class="content">
      ...
      <h1 class="titulo-seccion">CONTACTOS</h1>
      <div class="row">
        <div class="col-12">
            <button class="btn btn-success btn-sm" id="add-contact-btn">Añadir Contacto</button>
        </div>
      </div>
                ...
                <div class="card bg-light d-flex flex-fill">
                    ...
                    <div class="row">
                      <div class="col-7">
                        ...
                        <ul class="ml-4 mb-0 fa-ul text-muted">
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> {{!isset($contact->phone) ? 'No Especificado' : $contact->phone}}</li><hr>
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-envelope"></i></span> {{ $contact->email }}</li><hr>
                        </ul>
                      </div>
                  ...
                  <div class="card-footer">
                    <div class="text-right">
                      ...
                      <a href="{{ route('admin.contact', ['id' => $contact->id]) }}" class="btn btn-sm btn-primary">
    ...
    <div class="modal-style" id="add-contact-modal">
        <div class="card">
            <div class="card-header"><h5>Añadir Nuevo Contacto <span class="float-right close-modal">X</span> </h5></div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="" class="form-control" value="{{ old('assigned') }}">
                        ...
                        {{-- /.col-md-6 --}}
                         ...
                         {{-- /.row  --}}                    
                    <button class="btn btn-primary btn-sm btn-block">Añadir Nuevo Contacto</button>
                </form>
            </div>
        </div>
    </div>
