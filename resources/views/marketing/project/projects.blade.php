...
@if ( !$projects->isEmpty() ) 
    ...
    @foreach ( $projects  as $project)
      <tr>
        ...
        <td>
          <a class="btn btn-primary" href="{{ route('admin.project.edit', [ 'id' => $project->id ]) }}"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>          
          <a class="btn btn-danger" href="{{ route('admin.project.delete', [ 'id' => $project->id ]) }}" Onclick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>&nbsp;&nbsp;
        </td>
