...
class ProspectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketing.prospect.prospects', compact('prospects','user'));
    ...
    public function show($id)
    {
        ...
        if(!$prospect || !$prospect->assigned==Auth::id() || !$prospect->isProspect){
            return redirect('marketing/prospects')->with('error','No se ha Encontrado el Prospecto');
        }       
        
        return view('marketing.prospect.prospect', compact('prospect','user'));
    }
}
