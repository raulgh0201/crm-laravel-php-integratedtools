...
class VentasController extends Controller
{
    ...
    public function index()
    {
        ...
        $ventasConTotales = Venta::join("productos_vendidos", "productos_vendidos.id_venta", "=", "ventas.id")
            ...
            ->groupBy("ventas.id", "ventas.created_at", "ventas.updated_at", "ventas.id_cliente", "ventas.id_usuario")
            ->get();
        return view("ventas.ventas.ventas_index", ["ventas" => $ventasConTotales,"user" => $user]);
    }
    ...
    public function show(Venta $venta)
    {
        ...
        return view("ventas.ventas.ventas_show", [
            "venta" => $venta,
            "total" => $total,
            "user" => $user,
        ]);
    ...
    {
        $venta->delete();
        return redirect()->route("sales.ventas.index")
